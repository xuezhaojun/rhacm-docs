...
// 14. Do we need a section on the how to use ManagedClusterImageRegistry CRD?
...
// 15. This section's name is confusing. First, I thought we can use the CRD to import a cluster, but at the last step, it goes back to the console.
